...
<header class="header">
    <div class="containerr">
        <div class="logo">
            <a href="../HomePage.php"><img src="../../../public/img/ESCUDO COPA DAS PANELAS.png" alt="Grupo Ninja Logo"></a>
        </div>
        <nav class="nav-icons">
            <!-- Navegação com ícones -->
            <div class="nav-item"><a href="rodadas_adm.php"><img src="../../../public/img/header/rodadas.png" alt="Soccer Icon"></a><span>Rodadas</span></div>
            <div class="nav-item"><a href="tabela_de_classificacao.php"><img src="../../../public/img/header/campo.png" alt="Field Icon"></a><span>Classificação</span></div>
